...
public class Latex_kamona_HSguy_dragonwolf<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "latex_kamona_hsguy_dragonwolf"), "main");
	...
	public Latex_kamona_HSguy_dragonwolf(ModelPart root) {
		...
		this.RightPad3 = this.LeftPad.getChild("RightPad3");
		...
		this.Hair2 = this.TailQuaternary.getChild("Hair2");
