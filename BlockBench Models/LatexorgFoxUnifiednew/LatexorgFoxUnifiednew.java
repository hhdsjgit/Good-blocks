...
public class LatexorgFoxUnifiednew<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "latexorgfoxunifiednew"), "main");
	...
	private final ModelPart RightLowerLeg3;
	private final ModelPart RightFoot3;
	private final ModelPart RightPad3;
	...
	public LatexorgFoxUnifiednew(ModelPart root) {
		...
		this.hair2 = this.RightLeg.getChild("hair2");
		this.RightLeg2 = this.hair2.getChild("RightLeg2");
		...
		this.hair3 = this.LeftLeg.getChild("hair3");
		this.RightLeg3 = this.hair3.getChild("RightLeg3");
		this.RightLowerLeg3 = this.RightLeg3.getChild("RightLowerLeg3");
		this.RightFoot3 = this.RightLowerLeg3.getChild("RightFoot3");
		this.RightPad3 = this.RightFoot3.getChild("RightPad3");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hair2 = RightLeg.addOrReplaceChild("hair2", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition RightLeg2 = hair2.addOrReplaceChild("RightLeg2", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition RightThigh_r2 = RightLeg2.addOrReplaceChild("RightThigh_r2", CubeListBuilder.create().texOffs(64, 0).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.12F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));
		...
		PartDefinition RightCalf_r2 = RightLowerLeg2.addOrReplaceChild("RightCalf_r2", CubeListBuilder.create().texOffs(80, 0).addBox(-1.99F, -0.125F, -2.9F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.12F)), PartPose.offsetAndRotation(0.0F, -2.125F, 1.95F, 0.8727F, 0.0F, 0.0F));
		...
		PartDefinition RightArch_r2 = RightFoot2.addOrReplaceChild("RightArch_r2", CubeListBuilder.create().texOffs(70, 11).addBox(-2.0F, -8.45F, -0.725F, 4.0F, 6.0F, 3.0F, new CubeDeformation(0.12F)), PartPose.offsetAndRotation(0.0F, 7.075F, -4.975F, -0.3491F, 0.0F, 0.0F));

		PartDefinition RightPad2 = RightFoot2.addOrReplaceChild("RightPad2", CubeListBuilder.create().texOffs(64, 21).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.12F)), PartPose.offset(0.0F, 4.325F, -4.425F));
		...
		PartDefinition hair3 = LeftLeg.addOrReplaceChild("hair3", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition RightLeg3 = hair3.addOrReplaceChild("RightLeg3", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition RightThigh_r3 = RightLeg3.addOrReplaceChild("RightThigh_r3", CubeListBuilder.create().texOffs(64, 39).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.12F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));

		PartDefinition RightLowerLeg3 = RightLeg3.addOrReplaceChild("RightLowerLeg3", CubeListBuilder.create(), PartPose.offset(0.0F, 6.375F, -3.45F));

		PartDefinition RightCalf_r3 = RightLowerLeg3.addOrReplaceChild("RightCalf_r3", CubeListBuilder.create().texOffs(80, 39).addBox(-1.99F, -0.125F, -2.9F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.12F)), PartPose.offsetAndRotation(0.0F, -2.125F, 1.95F, 0.8727F, 0.0F, 0.0F));

		PartDefinition RightFoot3 = RightLowerLeg3.addOrReplaceChild("RightFoot3", CubeListBuilder.create(), PartPose.offset(0.0F, 0.8F, 7.175F));

		PartDefinition RightArch_r3 = RightFoot3.addOrReplaceChild("RightArch_r3", CubeListBuilder.create().texOffs(70, 50).addBox(-2.0F, -8.45F, -0.725F, 4.0F, 6.0F, 3.0F, new CubeDeformation(0.12F)), PartPose.offsetAndRotation(0.0F, 7.075F, -4.975F, -0.3491F, 0.0F, 0.0F));

		PartDefinition RightPad3 = RightFoot3.addOrReplaceChild("RightPad3", CubeListBuilder.create().texOffs(64, 60).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.12F)), PartPose.offset(0.0F, 4.325F, -4.425F));
		...
		.texOffs(0, 68).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.1F)), PartPose.offset(-5.0F, 1.5F, 0.0F));
		...
		.texOffs(47, 59).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.1F)), PartPose.offset(5.0F, 1.5F, 0.0F));
