...
import net.hhdsj.goodblock.client.model.latex_dragon.ModelDarkPurpleLatexDragon;
...
public class LatexDarkPurpleDragonRenderer extends AdvancedHumanoidRenderer<DarkPurpleLatexDragonEntity, ModelDarkPurpleLatexDragon> {
    public LatexDarkPurpleDragonRenderer(EntityRendererProvider.Context context) {
        ...
        this.addLayer(new EmissiveBodyLayer<>(this, new ResourceLocation("goodblock", "textures/entities/latex/latex_taur/dark_purple_latex_dragon_light.png")));
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull DarkPurpleLatexDragonEntity p_114482_) {
        return new ResourceLocation("goodblock:textures/entities/latex/latex_taur/dark_purple_latex_dragon.png");
    }
}