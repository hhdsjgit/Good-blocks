...
public class CatalyzerguiScreen extends AbstractContainerScreen<CatalyzerguiMenu> {
	private final static HashMap<String, Object> guistate = CatalyzerguiMenu.guistate;
	...
	private static final ResourceLocation texture = new ResourceLocation("goodblock:textures/screens/catalyzergui.png");
