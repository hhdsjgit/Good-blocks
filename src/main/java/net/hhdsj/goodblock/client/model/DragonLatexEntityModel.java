...
public class DragonLatexEntityModel extends AdvancedHumanoidModel<DragonLatexEntity> implements AdvancedHumanoidModelInterface<DragonLatexEntity, DragonLatexEntityModel> {
    ...
    private final HumanoidAnimator<DragonLatexEntity, DragonLatexEntityModel> animator;

    public DragonLatexEntityModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(DragonLatexEntity p_102861_, float p_102862_, float p_102863_, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull DragonLatexEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
