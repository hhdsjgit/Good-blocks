...
public class ModelLatexIceFieldWolfDragonBoss extends AdvancedHumanoidModel<LatexIceFieldWolfDragonBossEntity> implements AdvancedHumanoidModelInterface<LatexIceFieldWolfDragonBossEntity, ModelLatexIceFieldWolfDragonBoss> {
    ...
    private final HumanoidAnimator<LatexIceFieldWolfDragonBossEntity, ModelLatexIceFieldWolfDragonBoss> animator;

    public ModelLatexIceFieldWolfDragonBoss(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(@NotNull LatexIceFieldWolfDragonBossEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
