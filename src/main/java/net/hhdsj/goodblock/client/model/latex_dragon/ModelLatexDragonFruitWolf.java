...
public class ModelLatexDragonFruitWolf extends AdvancedHumanoidModel<LatexDragonFruitWolfEntity>{
    ...
    private final HumanoidAnimator<LatexDragonFruitWolfEntity, ModelLatexDragonFruitWolf> animator;

    public ModelLatexDragonFruitWolf(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(@NotNull LatexDragonFruitWolfEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<LatexDragonFruitWolfEntity, ModelLatexDragonFruitWolf> getAnimator(LatexDragonFruitWolfEntity entity) {
        return animator;
    }
}