...
public class ModelLatexPurpleCoocWolf extends AdvancedHumanoidModel<LatexPurplecoocwolfEntity> implements AdvancedHumanoidModelInterface<LatexPurplecoocwolfEntity, ModelLatexPurpleCoocWolf> {//<T extends Entity> extends EntityModel<T> {
	...
	public final HumanoidAnimator<LatexPurplecoocwolfEntity, ModelLatexPurpleCoocWolf> animator;

	public ModelLatexPurpleCoocWolf(ModelPart root) {
		super(root);
    ...
    public ModelPart getTorso() {
	 ...
	 @Override
    public HumanoidAnimator<LatexPurplecoocwolfEntity, ModelLatexPurpleCoocWolf> getAnimator(LatexPurplecoocwolfEntity entity) {
        return this.animator;
    }

    public void setupAnim(@NotNull LatexPurplecoocwolfEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
