package net.hhdsj.goodblock.client.model.latex_pup;
...
public class ModelInksuger extends AdvancedHumanoidModel<InksugerEntity>{
    ...
    private final HumanoidAnimator<InksugerEntity, ModelInksuger> animator;

    public ModelInksuger(ModelPart root) {
        super(root);
	...
	/*
    @Override
    public void prepareMobModel(InksugerEntity p_102861_, float p_102862_, float p_102863_, float p_102864_) {
        this.prepareMobModel(p_102861_, p_102862_, p_102863_, p_102864_);
    }*/

    public void setupHand(InksugerEntity entity) {
        animator.setupHand();
    }
	...
	@Override
    public void prepareMobModel(InksugerEntity entity, float limbSwing, float limbSwingAmount, float partialTicks) {
	 ...
	 @Override
    public void setupAnim(@NotNull InksugerEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<InksugerEntity, ModelInksuger> getAnimator(InksugerEntity entity) {
        return animator;
    }
}
