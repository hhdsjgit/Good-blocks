...
public class LatexfoxEntity extends ChangedEntity {
	public LatexfoxEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(GoodblockModEntities.LATEXFOX.get(), world);
	}
