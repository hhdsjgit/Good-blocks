...
public class LatextestEntity extends Monster {
	public LatextestEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(GoodblockModEntities.LATEXTEST.get(), world);
	}

	public LatextestEntity(EntityType<LatextestEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
