...
import net.hhdsj.goodblock.client.renderer.LatexPurpleCoocWolfRenderer;
...
public class GoodblockEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(GoodblockEntities.LATEXPRTPLECOOCWOLF.get(), LatexPurpleCoocWolfRenderer::new);
