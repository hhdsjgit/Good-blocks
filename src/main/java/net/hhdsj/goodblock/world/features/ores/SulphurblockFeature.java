...
public class SulphurblockFeature extends OreFeature {
	...
	private static class SulphurblockFeatureRuleTest extends RuleTest {
		static final SulphurblockFeatureRuleTest INSTANCE = new SulphurblockFeatureRuleTest();
		private static final com.mojang.serialization.Codec<SulphurblockFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<SulphurblockFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;
