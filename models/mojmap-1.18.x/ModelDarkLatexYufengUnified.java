...
public class ModelDarkLatexYufengUnified<T extends Entity> extends EntityModel<T> {
	...
	private final ModelPart TopHorn;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Mask = Head.addOrReplaceChild("Mask",
				CubeListBuilder.create().texOffs(0, 5)
						.addBox(-1.0F, -31.0F, -5.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 38)
						.addBox(-2.0F, -33.0F, -5.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(64, 28)
						.addBox(-3.0F, -32.0F, -5.0F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 21)
						.addBox(-1.0F, -34.0F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 32)
						.addBox(-4.0F, -31.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 32)
						.addBox(3.0F, -31.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(64, 26)
						.addBox(-3.0F, -29.0F, -5.0F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 22)
						.addBox(-4.0F, -28.0F, -5.0F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(61, 9)
		...
		PartDefinition Base_r9 = TailPrimary.addOrReplaceChild("Base_r9",
				CubeListBuilder.create().texOffs(56, 57).addBox(-2.0F, -2.9F, 0.4F, 4.0F, 4.0F, 4.0F,
