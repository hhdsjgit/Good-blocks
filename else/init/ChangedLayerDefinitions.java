...
public class ChangedLayerDefinitions {
    ...
    public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(LatexKoboldModel.LAYER_LOCATION, LatexKoboldModel::createBodyLayer);
        ...
        ArmorLatexHeavyWolfModel.MODEL_SET.registerDefinitions(event::registerLayerDefinition);
        ...
        ArmorLatexHeavyCatModel.MODEL_SET.registerDefinitions(event::registerLayerDefinition);
        ...
        ArmorLatexHeavyDragonModel.MODEL_SET.registerDefinitions(event::registerLayerDefinition);
        ...
        ArmorLatexHeavySharkModel.MODEL_SET.registerDefinitions(event::registerLayerDefinition);
        ...
        ArmorHeavyMermaidSharkUpperBodyModel.MODEL_SET.registerDefinitions(event::registerLayerDefinition);
