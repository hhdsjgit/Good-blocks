...
import net.hhdsj.goodblock.entity.SADASDEntity;
...
public class GoodblockModEntities {
	...
	public static final RegistryObject<EntityType<SADASDEntity>> SADASD = register("sadasd",
			EntityType.Builder.<SADASDEntity>of(SADASDEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(SADASDEntity::new)
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(SADASD.get(), SADASDEntity.createAttributes().build());
	}
}
