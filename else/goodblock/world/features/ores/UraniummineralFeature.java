...
package net.hhdsj.goodblock.world.features.ores;
...
public class UraniummineralFeature extends OreFeature {
	...
	private static class UraniummineralFeatureRuleTest extends RuleTest {
		static final UraniummineralFeatureRuleTest INSTANCE = new UraniummineralFeatureRuleTest();
		private static final com.mojang.serialization.Codec<UraniummineralFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<UraniummineralFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;
